    ...
    >
        ...
        <ContentGroup class="mt-auto">
            ...
            >
                ...
                <b class="group-hover-text-theme text-xs">{{ $t('sign_in_or_create_account') }}</b>
            </router-link>
            <div
            ...
            >
                ...
                <b class="group-hover-text-theme text-xs">
                    {{ $t('set_theme_mode', { mode: isDarkMode ? $t('light_mode') : $t('dark_mode') }) }}
                </b>
            </div>
        </ContentGroup>
    </ContentSidebar>
